package com.lsqingfeng.action.web.rocketmq.producer;

import com.alibaba.fastjson.TypeReference;
import com.lsqingfeng.action.web.rocketmq.domain.OrderPaidEvent;
import com.lsqingfeng.action.web.rocketmq.domain.ProductWithPayload;
...
/**
 * 实现CommandLineRunner:  服务启动时执行
 * 案例官网： https://github.com/apache/rocketmq-spring/
 *
 * 前提：
 *      1.搭建好rocketmq集群
 *      2. 创建好如下topic:
